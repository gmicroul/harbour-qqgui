    ...
    SilicaListView {
        ...
        header: Column {
            ...
            Row {
                ...
                visible: targetId !== 0
                Rectangle {
                    width: 56; height: 56; radius: Theme.paddingSmall
                    clip: true
                ...
                Column {
                    ...
                    Label { text: page.targetTitle; color: Theme.primaryColor; font.pixelSize: Theme.fontSizeMedium; font.bold: true }
                    Label { text: isGroup ? qsTr("Group") + " · " + targetId : qsTr("Private") + " · " + targetId; color: Theme.secondaryColor; font.pixelSize: Theme.fontSizeExtraSmall }
                }
            }
        }
                ...
                Column {
                    ...
                    Row {
                        ...
                        Label {
                            anchors.verticalCenter: parent.verticalCenter
                            font.pixelSize: Theme.fontSizeExtraSmall
                            color: model.mine ? Theme.secondaryColor : Theme.highlightColor
                            font.bold: true

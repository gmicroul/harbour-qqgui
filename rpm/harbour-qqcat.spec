...
%changelog
* Thu Sep 4 2026 qqbridge contributors 1.0.0-31
- Switch to pure Silica: remove glass, use Theme colors, PageHeader/ListItem native
- Keep real QQ avatars (Conversations/Chat header/bubble) via q.qlogo.cn
- Preserve fixes: input auto-grow, sendButton, preview handling

...
sudo -n mkdir -p /usr/share/harbour-qqcat/qml/pages /usr/share/harbour-qqcat/qml/cover /usr/share/harbour-qqcat/qml/images /usr/share/harbour-qqcat/qml/components /usr/share/harbour-qqcat/qml/js
...
sudo -n cp qml/components/*.qml /usr/share/harbour-qqcat/qml/components/
sudo -n cp qml/js/*.js /usr/share/harbour-qqcat/qml/js/
sudo -n chmod 755 /usr/share/harbour-qqcat/qml/js /usr/share/harbour-qqcat/qml/components
sudo -n chmod 644 /usr/share/harbour-qqcat/qml/js/*.js /usr/share/harbour-qqcat/qml/components/*.qml
